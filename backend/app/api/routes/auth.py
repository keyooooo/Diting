...
from app.core.security import authenticate_user, check_login_rate_limit, create_access_token, get_current_user, get_db, get_password_hash, resolve_role
from app.models import User
from app.schemas import AuthResponse, CurrentUserResponse, LoginRequest, RegisterRequest
...
@router.post("/auth/login", response_model=AuthResponse, dependencies=[Depends(check_login_rate_limit)])
